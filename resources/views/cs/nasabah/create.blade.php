...
<div class="container-fluid">
    ...
    <div class="page-header">
        ...
        <div class="page-subtitle">Isi formulir di bawah untuk menambahkan nasabah baru</div>
    </div>
            ...
            <div class="form-card">
                ...
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <p>Semua field yang bertanda (<span class="text-danger">*</span>) wajib diisi. Pastikan NIK yang dimasukkan valid dan belum terdaftar.</p>
                    </div>
                </div>

                <form method="POST" action="{{ route('cs.nasabah.store') }}">
                    @csrf
