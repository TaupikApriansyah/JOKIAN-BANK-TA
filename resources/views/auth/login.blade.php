...
<div class="min-h-screen lg:grid lg:grid-cols-2">
    ...
    <section class="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_100%_0%,rgba(201,120,89,.10),transparent_30%),#fbfaf6] px-4 py-10 sm:px-6">
        <div class="glass-card max-w-md fade-slide">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div>
                    <div class="uiverse-form-control">
                        <input id="email" type="email" class="uiverse-input @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autofocus autocomplete="email" placeholder=" ">
            ...
            <p class="mt-7 text-center text-xs text-slate-400">© {{ date('Y') }} SIBERKAS — Sistem Informasi Berkas</p>
        </div>
    </section>
</div>
